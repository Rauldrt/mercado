...
import CustomerForm from '../admin/customer-form';
  ...
  const handleCustomerCreated = async (newCustomerData: Omit<Customer, 'id' | 'purchaseHistory' | 'userId'>) => {
    ...
    try {
        ...
        toast({
            ...
            description: `"${newCustomerData.firstName} ${newCustomerData.lastName}" ha sido creado y seleccionado.`,
        });
    } catch (error) {
        console.error("Failed to create customer from checkout:", error);
        toast({
            variant: "destructive",
            title: "Error",
              ...
              <CardContent className="space-y-4">
                  <FormField
                      ...
                      render={({ field }) => (
                          ...
                          <Select onValueChange={handleSelectChange} value={field.value} disabled={loadingCustomers || showPostOrderActions}>
                              <FormControl>
                              <SelectTrigger>
                              ...
                              <SelectItem value="create_new_customer" className="font-semibold text-primary">
                                  Crear nuevo cliente...
                              </SelectItem>
                              </SelectContent>
                          </Select>
